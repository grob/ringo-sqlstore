 ...
 * @ignore
 */
const Storable = module.exports = function Storable() {};
...
Storable.defineEntity = function(store, type, mapping) {
    ...
    Object.keys(mapping.properties).forEach(function(key) {
        const propMapping = ctor.mapping.getMapping(key);
        Object.defineProperty(ctor.prototype, key, {
            get: function() {
                ...
                if (propMapping.isObjectMapping) {
                    const value = this._entity[propMapping.column];
    ...
    Object.defineProperties(ctor.prototype, {
        ...
        toJSON: {
            value: function() {
                ...
                Object.keys(ctor.mapping.properties).forEach(function(key) {
                    const propMapping = ctor.mapping.properties[key];
                    if (propMapping.isPrimitive) {
                        obj[key] = this[key];
                    }
                }, this);
