...
const idSequence = require("../database/sequence");
...
Mapping.create = function(dialect, type, definition) {
    ...
    mapping.addIdMapping(dialect, type, definition);
...
Mapping.prototype.addIdMapping = function(dialect, type, definition) {
    var sequence = idSequence.create(dialect, type, definition);
    var column = (definition.id && definition.id.column) || "id";
    var mapping = this.id = new IdMapping(this, column, sequence, dataTypes.long);
