 ...
 * @constructor
 */
const Mapping = module.exports = function(type, tableName, schemaName) {
...
Mapping.prototype.addIdMapping = function(dialect, definition) {
    ...
    const mapping = this.id = new IdMapping(this, dataTypes.long, definition);
...
Mapping.prototype.addPrimitiveProperty = function(name, definition) {
    ...
    const mapping = new PrimitiveMapping(this, name,
...
Mapping.prototype.addObjectProperty = function(name, definition) {
    const mapping = new ObjectMapping(this, name, definition, dataTypes.long);
    this.columns[mapping.column] = mapping;
    this.mappings.push(mapping);
    this.properties[name] = mapping;
};
...
Mapping.prototype.addCollectionProperty = function(name, definition) {
    const mapping = new CollectionMapping(this, name, definition);
...
Mapping.prototype.getMapping = function(property) {
    ...
    const propMapping = this.properties[property];
    if (propMapping === null || propMapping === undefined) {
