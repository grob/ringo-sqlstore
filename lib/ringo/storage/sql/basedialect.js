...
function BaseDialect() {
    ...
    this.registerJdbcType(java.sql.Types.BIGINT, new types.NumberType());
    ...
    this.registerJdbcType(java.sql.Types.INTEGER, new types.NumberType());
    this.registerJdbcType(java.sql.Types.SMALLINT, new types.NumberType());
    this.registerJdbcType(java.sql.Types.TINYINT, new types.NumberType());
    ...
    this.registerJdbcType(java.sql.Types.NUMERIC, new types.NumberType());
    this.registerJdbcType(java.sql.Types.DECIMAL, new types.NumberType());
