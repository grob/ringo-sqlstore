 ...
 * @type Array
 */
Store.prototype.executeQuery = function(sql, collector) {
    var conn = null;
    var statement = null;
    var resultSet = null;
    try {
        ...
        return collector.collect(this, resultSet);
    } finally {
...
Store.prototype.loadEntity = function(type, id) {
    ...
    var collector = new collectors.EntityDataCollector(mapping);
    var entities = this.executeQuery(sqlBuf.toString(), collector);
...
Store.prototype.isEntityExisting = function(type, id) {
    ...
    var result = this.executeQuery(sqlBuf.toString(), collector);
    if (result.length > 1) {
