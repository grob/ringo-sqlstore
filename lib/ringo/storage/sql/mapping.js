...
Mapping.prototype.getColumnType = function(columnName) {
    var propMapping = this.columns[columnName];
    if (propMapping == null) {
        throw new Error("No mapping found for column '" + columnName + "'");
    }
    return propMapping.getColumnType();
};
