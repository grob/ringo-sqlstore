 ...
 * @ignore
 */
var query = function query(store, selector, nparams) {
 ...
 * @ignore
 */
var createQueryParams = function createQueryParams(parent, params) {
    var descriptors = {};
    if (params !== null) {
 ...
 * @constructor
 */
var Collection = module.exports = function Collection(store, collectionMapping, selector, parent) {
    var ids = null;
    var storables = null;
 ...
 * @ignore
 */
var CollectionIterator = function CollectionIterator(collection) {
    var idx = 0;
