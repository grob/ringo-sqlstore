...
var BaseDialect = exports.BaseDialect = function() {
    /**
     * A map containing the JDBC type as key and the sqlstore type as value
     * @type {Object}
     * @ignore
     */
    var jdbcTypeMap = {};
    jdbcTypeMap[java.sql.Types.BIGINT] = new types.IntegerType();
    jdbcTypeMap[java.sql.Types.BINARY] = new types.BinaryType();
    jdbcTypeMap[java.sql.Types.BIT] = new types.BooleanType();
    jdbcTypeMap[java.sql.Types.BOOLEAN] = new types.BooleanType();
    jdbcTypeMap[java.sql.Types.CHAR] = new types.StringType();
    jdbcTypeMap[java.sql.Types.DATE] = new types.DateType();
    jdbcTypeMap[java.sql.Types.DOUBLE] = new types.FloatType();
    jdbcTypeMap[java.sql.Types.FLOAT] = new types.FloatType();
    jdbcTypeMap[java.sql.Types.INTEGER] = new types.IntegerType();
    jdbcTypeMap[java.sql.Types.SMALLINT] = new types.IntegerType();
    jdbcTypeMap[java.sql.Types.TINYINT] = new types.IntegerType();
    jdbcTypeMap[java.sql.Types.TIME] = new types.TimeType();
    jdbcTypeMap[java.sql.Types.TIMESTAMP] = new types.TimestampType();
    jdbcTypeMap[java.sql.Types.VARCHAR] = new types.StringType();
    jdbcTypeMap[java.sql.Types.VARBINARY] = new types.BinaryType();
    jdbcTypeMap[java.sql.Types.LONGVARCHAR] = new types.StringType();
    jdbcTypeMap[java.sql.Types.LONGVARBINARY] = new types.BinaryType();
    jdbcTypeMap[java.sql.Types.NUMERIC] = new types.IntegerType();
    jdbcTypeMap[java.sql.Types.DECIMAL] = new types.IntegerType();
    jdbcTypeMap[java.sql.Types.BLOB] = new types.BinaryType();
    jdbcTypeMap[java.sql.Types.CLOB] = new types.StringType();
    jdbcTypeMap[java.sql.Types.OTHER] = new types.OtherType();

    /**
     * A map containing the column types by name as used in sqlstore mappings
     * @type {Object}
     * @ignore
     */
    var columnTypes = {};
 ...
 * @returns {Type} The data type
 */
BaseDialect.prototype.getType = function(name) {
    return this.getJdbcType(this.getColumnType(name).jdbcType);
};
