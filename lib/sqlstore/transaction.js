...
Transaction.prototype.addInserted = function(storable) {
    return this.add(this.inserted, storable._key.getCacheKey(), storable);
};
...
Transaction.prototype.addUpdated = function(storable) {
    return this.add(this.updated, storable._key.getCacheKey(), storable);
};
...
Transaction.prototype.addDeleted = function(storable) {
    return this.add(this.deleted, storable._key.getCacheKey(), storable);
};
