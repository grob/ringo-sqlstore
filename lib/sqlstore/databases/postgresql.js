...
var Dialect = function() {
    ...
    // JSON data types supported by Postgres 9.2 (json) and 9.4 (jsonb)
    this.registerColumnType("json", new ColumnType(Types.OTHER, "json"));
    this.registerColumnType("jsonb", new ColumnType(Types.OTHER, "jsonb"));
