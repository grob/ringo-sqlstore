 ...
 * @constructor
 */
var Store = function(connectionPool) {
    var dialect = null;
    var entityRegistry = {};
    ...
    Object.defineProperties(this, {
        ...
        /**
         * Contains the entity cache of this store
         * @type Cache
         */
        "entityCache": {
            "get": function() {
     ...
     * @param {Cache} c The entity cache to use
     */
    this.setEntityCache = function(c) {
        entityCache = c;
    };

    /**
     * Sets the cache passed as argument as query cache of this store
     * @param {Cache} c The query cache to use
     */
    this.setQueryCache = function(c) {
        queryCache = c;
    };

    /**
     * Returns true if this store has an entity cache
     * @returns True if the store has an entity cache, false otherwise
     * @type Boolean
     */
    this.hasEntityCache = function() {
        return entityCache !== null;
    };

    /**
     * Returns true if this store has a query cache
     * @returns True if the store has a query cache, false otherwise
     * @type Boolean
     */
    this.hasQueryCache = function() {
        return queryCache !== null;
    };
...
Store.prototype.determineDialect = function() {
    var driver = this.connectionPool.getDriverClass().getClass().getName();
...
Store.prototype.getEntity = function(storable) {
    ...
    var useCache = this.hasEntityCache() &&
...
/**
 * Returns the result of the given SQL query
 ...
 * @returns An array containing all instances of the given type
 * @type Array
 */
