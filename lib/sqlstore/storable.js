 ...
 * @type {Number}
 */
// FIXME: needed to put this above all, because requiring collection
// below leads to a circular dependency!?
// (query -> collectorgenerator -> storable -> Collection -> query)
var LOAD_LAZY = exports.LOAD_LAZY = -1;
...
Storable.defineEntity = function(store, type, mapping) {
    ...
    Object.keys(mapping.properties).forEach(function(key) {
        ...
        Object.defineProperty(ctor.prototype, key, {
            get: function() {
                ...
                if (!this._entity || this._entity === LOAD_LAZY) {
    ...
    Object.defineProperties(ctor.prototype, {
        /**
         * Left for backwards compatibility (use id property instead)
         * @type Number
