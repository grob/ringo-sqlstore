  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_selectExpression() {
        ...
        pos0 = pos;
        pos1 = pos;
        result0 = parse_selectAggregation();
        if (result0 === null) {
          result0 = parse_selectIdent();
          if (result0 === null) {
      ...
      function parse_selectEntity() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, entity, aggressive) {
      ...
      function parse_selectAggregation() {
        var result0, result1, result2, result3;
        var pos0, pos1;
        ...
        if (result0 !== null) {
          result0 = (function(offset, type, ident) {
      ...
      function parse_fromClause() {
        ...
        result0 = parse_FROM();
        if (result0 !== null) {
          result1 = parse_fromExpression();
          if (result1 !== null) {
            result2 = [];
            pos2 = pos;
            result3 = parse_comma();
            if (result3 !== null) {
              result4 = parse_fromExpression();
              if (result4 !== null) {
      ...
      function parse_joinClause() {
        ...
        result0 = parse_innerJoin();
        if (result0 === null) {
          result0 = parse_outerJoin();
        }
        return result0;
      }
      ...
      function parse_innerJoin() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, entities, predicate) {
      ...
      function parse_outerJoin() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, side, entities, predicate) {
