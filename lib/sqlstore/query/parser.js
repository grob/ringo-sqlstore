    ...
    parse: function(input, startRule) {
      ...
      function parse_condition_rhs() {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, not, start, end) {
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              ...
              if (result1 !== null) {
                ...
                if (result2 !== null) {
                  result3 = parse_select();
                  if (result3 === null) {
                    result3 = parse_valueList();
                  }
                  if (result3 !== null) {
                    result4 = parse_RPAREN();
                    if (result4 !== null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, not, values) {
            ...
            if (result0 === null) {
              ...
              if (result0 !== null) {
                result0 = (function(offset, compare, rhs) {
      ...
      function parse_compare_rhs() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, range, select) {
      ...
      function parse_order() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, expr, sort, nulls) {
      ...
      function parse_NULLS() {
        ...
        pos0 = pos;
        pos1 = pos;
        if (input.substr(pos, 5).toLowerCase() === "nulls") {
          result0 = input.substr(pos, 5);
          pos += 5;
        } else {
          result0 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset) { return "NULLS"; })(pos0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_FIRST() {
        ...
        pos0 = pos;
        pos1 = pos;
        if (input.substr(pos, 5).toLowerCase() === "first") {
          result0 = input.substr(pos, 5);
          pos += 5;
        } else {
          result0 = null;
      ...
      function parse_ANY() {
        ...
        pos0 = pos;
        pos1 = pos;
        if (input.substr(pos, 3).toLowerCase() === "any") {
          result0 = input.substr(pos, 3);
          pos += 3;
        } else {
          result0 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset) { return "ANY"; })(pos0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_SOME() {
        ...
        pos0 = pos;
        pos1 = pos;
        if (input.substr(pos, 4).toLowerCase() === "some") {
          result0 = input.substr(pos, 4);
          pos += 4;
        } else {
          result0 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset) { return "SOME"; })(pos0);
        }
        if (result0 === null) {
          pos = pos0;
        }
