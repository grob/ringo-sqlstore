  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "selectModifier": parse_selectModifier,
      ...
      function parse_select() {
        ...
        if (result0 !== null) {
          result1 = parse_fromClause();
          if (result1 !== null) {
            result2 = parse_joinClause();
            result2 = result2 !== null ? result2 : "";
            if (result2 !== null) {
              result3 = parse_whereClause();
              result3 = result3 !== null ? result3 : "";
              if (result3 !== null) {
                result4 = parse_groupByClause();
                result4 = result4 !== null ? result4 : "";
                if (result4 !== null) {
                  result5 = parse_havingClause();
                  result5 = result5 !== null ? result5 : "";
                  if (result5 !== null) {
                    result6 = parse_orderByClause();
                    result6 = result6 !== null ? result6 : "";
                    if (result6 !== null) {
                      result7 = parse_rangeClause();
        ...
        if (result0 !== null) {
          result0 = (function(offset, sc, fc, jc, wc, gc, hc, oc, rc) {
                if (!sc) {
            ...
            })(pos0, result0[0], result0[1], result0[2], result0[3], result0[4], result0[5], result0[6], result0[7]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_selectClause() {
        ...
        result0 = parse_SELECT();
        if (result0 !== null) {
          result1 = parse_selectModifier();
          result1 = result1 !== null ? result1 : "";
          if (result1 !== null) {
            result2 = parse_selectExpression();
            if (result2 !== null) {
              result3 = [];
              pos2 = pos;
              result4 = parse_comma();
              if (result4 !== null) {
                result5 = parse_selectExpression();
                if (result5 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, sm, head, tail) {
      ...
      function parse_selectModifier() {
        var result0;
        var pos0;
        
        pos0 = pos;
        result0 = parse_DISTINCT();
        if (result0 === null) {
          result0 = parse_ALL();
        }
        if (result0 !== null) {
