...
var Operand = exports.Operand = function Operand(summands) {
    Object.defineProperties(this, {
         ...
         * @type Array
         */
        "summands": {"value": summands, "enumerable": true}
    });
    return this;
};
/** @ignore */
...
var ConditionList = exports.ConditionList = function ConditionList(conditions, operator) {
    Object.defineProperties(this, {
        ...
        /**
         * The logical operator of this condition list
         * @type String
         */
        "operator": {"value": operator, "enumerable": true},
        /**
         * Contains the number of conditions of this list
         * TODO: remove, there's conditions.length
         * @type Number
         */
        "length": {
            "get": function() {
...
/**
 * Creates a new AllSome instance
 ...
 * @returns A newly created AllSome instance
 * @constructor
 */
var AllSome = exports.AllSome = function AllSome(range, select) {
    Object.defineProperties(this, {
        /**
         * The range
         * @type String
...
/** @ignore */
AllSome.prototype = Object.create(Node.prototype);
/** @ignore */
AllSome.prototype.constructor = AllSome;

/**
 * Calls the method `visitAllSome` of the visitor passed as argument, passing
 * this instance as argument.
 * @param {Object} visitor The visitor
 * @returns The value returned by the visitor
 */
AllSome.prototype.accept = function(visitor) {
    return visitor.visitAllSome(this);
};
...
var Expression = exports.Expression = function Expression(andConditions, orConditions) {
    Object.defineProperties(this, {
         ...
         * @type Array
         */
        "andConditions": {"value": andConditions || null, "enumerable": true},
        /**
         * The list of `OR` conditions
         * @type Array
         */
        "orConditions": {"value": orConditions || null, "enumerable": true}
    });
    return this;
};
/** @ignore */
