...
Entity.prototype.getMapping = function(visitor) {
...
Ident.prototype.getMapping = function(visitor) {
...
AliasIdent.prototype.getMapping = function(visitor) {
    return visitor.getEntityMapping(this.alias).getMapping(this.property);
};
...
SelectEntity.prototype.getMapping = function(visitor) {
    return visitor.getEntityMapping(this.entity);
};
...
SelectExpression.prototype.getMapping = function(visitor) {
    return this.expression.getMapping(visitor);
};
...
Aggregation.prototype.getMapping = function(visitor) {
    return this.value.getMapping(visitor);
};
