...
var SelectClause = exports.SelectClause = function SelectClause(list, modifier) {
    Object.defineProperties(this, {
        ...
        "list": {"value": list, "enumerable": true},
        /**
         * The select modifier (distinct/all)
         * @type String
         */
        "modifier": {"value": modifier || null, "enumerable": true}
    });
    return this;
};
/** @ignore */
...
var Aggregation = exports.Aggregation = function Aggregation(type, ident, distinct) {
    Object.defineProperties(this, {
         ...
         * @type String
         */
        "distinct": {"value": distinct || null, "enumerable": true}
    });
    return this;
};
/** @ignore */
 ...
 * @constructor
 */
var Select = exports.Select = function Select(aliases, select, from, join, where, groupBy, having, orderBy, range) {
    Object.defineProperties(this, {
        /**
