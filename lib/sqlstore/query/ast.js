...
var SelectAggregation = exports.SelectAggregation = function SelectAggregation(type, ident, isDistinct) {
    Object.defineProperties(this, {
...
SelectAggregation.prototype.getColumnAlias = function() {
    return this.resultName || this.type + "_" + this.value.getColumnAlias();
};
