...
SqlFunctionGenerator.prototype.createSqlFunction = function(ast) {
...
SqlFunctionGenerator.createSqlFunction = function(store, ast) {
    var generator = new SqlFunctionGenerator(store, ast.aliases);
