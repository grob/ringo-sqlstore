...
SqlGenerator.prototype.visitEntity = function(node) {
    return this.getEntityMapping(node.entity).getQualifiedTableName(this.store.dialect);
};

SqlGenerator.prototype.visitIdent = function(node) {
    var mapping = this.getEntityMapping(node.entity).getMapping(node.property);
    return mapping.getQualifiedColumnName(this.store.dialect);
};

SqlGenerator.prototype.visitAliasIdent = function(node) {
    var mapping = this.getEntityMapping(node.alias).getMapping(node.property);
...
SqlGenerator.prototype.visitSelectEntity = function(node) {
    var mapping = this.store.getEntityMapping(node.entity);
