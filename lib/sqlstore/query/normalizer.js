...
/**
 * Normalizes the nested all/any/some select statement
 * @param {AllSome} node The node
 * @returns {String} The string representation
 */
Normalizer.prototype.visitAllSome = function(node) {
    return node.range + " (" + node.select.accept(this) + ")";
};
