...
/**
 * Returns a newly created OtherType instance used for non-JDBC data types
 * @class Instances of this class represent an character property type
 * @returns A newly created OtherType instance
 * @constructor
 */
var OtherType = exports.OtherType = function() {
    return this;
};

/** @ignore */
OtherType.prototype.toString = function() {
    return "[OtherType]";
};
 ...
 * @returns {String} The result set value at the given column index position
 */
OtherType.prototype.get = function(resultSet, idx) {
 ...
 * @param {Number} idx The 1-based index position of the column
 */
OtherType.prototype.set = function(preparedStatement, value, idx) {
    preparedStatement.setObject(idx, value, java.sql.Types.OTHER);
};