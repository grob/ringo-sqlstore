...
var dataTypes = require("../datatypes/all");
 ...
 * @constructor
 */
var SqlGenerator = module.exports = function(store) {
...
SqlGenerator.prototype.visitEntity = function(node) {
    ...
    var result = this.store.dialect.quote(mapping.tableName, mapping.schemaName);
    if (node.alias) {
        result += " " + node.alias;
    }
    return result;
...
SqlGenerator.prototype.visitIdent = function(node) {
    ...
    var alias = this.entityToAlias[propMapping.parent.type] || null;
...
SqlGenerator.prototype.visitSubSelect = function(node) {
    var subGen = new this.store.dialect.SqlGenerator(this.store);
