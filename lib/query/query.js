 ...
 */
var createCollector = exports.createCollector = function(collectors) {
 ...
 */
var createSelector = exports.createSelector = function(store, ast) {
    var generator = new store.dialect.SqlGenerator(store, ast.aliases);
    var sql = ast.accept(generator);
    var collector = createCollector(generator.collectors);
    return {
        "sql": sql,
