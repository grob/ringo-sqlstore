 ...
 * @see #ParameterValue
 */
const Value = exports.Value = function Value() {
    return this;
};
/** @ignore */
 ...
 * @see #Value
 */
const StringValue = exports.StringValue = function StringValue(value) {
    this.value = value;
    return this;
};
/** @ignore */
 ...
 * @see #Value
 */
const IntValue = exports.IntValue = function IntValue(value) {
    this.value = value;
    return this;
};
/** @ignore */
 ...
 * @see #Value
 */
const DecimalValue = exports.DecimalValue = function DecimalValue(value) {
    this.value = value;
    return this;
};
/** @ignore */
 ...
 * @see #Value
 */
const BooleanValue = exports.BooleanValue = function BooleanValue(value) {
    this.value = value;
    return this;
};
/** @ignore */
 ...
 * @see #Value
 */
const NullValue = exports.NullValue = function NullValue() {
    this.value = null;
    return this;
};
/** @ignore */
 ...
 * @see #Value
 */
const ParameterValue = exports.ParameterValue = function ParameterValue(name) {
    this.value = name;
    return this;
};
/** @ignore */
 ...
 * @constructor
 */
const Operand = exports.Operand = function Operand(summands) {
 ...
 * @constructor
 */
const Summand = exports.Summand = function Summand(left, operand, right) {
    this.left = left;
 ...
 * @constructor
 */
const Factor = exports.Factor = function Factor(left, operand, right) {
    this.left = left;
    this.operand = operand;
    this.right = right;
    return this;
 ...
 * @constructor
 */
const Entity = exports.Entity = function Entity(name, alias) {
    this.name = name;
    this.alias = alias;
    return this;
};
 ...
 * @constructor
 */
const Ident = exports.Ident = function Ident(entity, property) {
    this.entity = entity;
 ...
 * @constructor
 */
const Comparison = exports.Comparison = function Comparison(operator, value) {
 ...
 * @constructor
 */
const Condition = exports.Condition = function Condition(left, right) {
    this.left = left;
    this.right = right;
    return this;
};
 ...
 * @constructor
 */
const NotCondition = exports.NotCondition = function NotCondition(value) {
    this.value = value;
    return this;
};
/** @ignore */
 ...
 * @constructor
 */
const ExistsCondition = exports.ExistsCondition = function ExistsCondition(select) {
    this.select = select;
    return this;
};
/** @ignore */
 ...
 * @constructor
 */
const IsNullCondition = exports.IsNullCondition = function IsNullCondition(not) {
    this.isNot = not === true;
    return this;
};
/** @ignore */
 ...
 * @constructor
 */
const BetweenCondition = exports.BetweenCondition = function BetweenCondition(start, end, not) {
    this.isNot = not === true;
    this.start = start;
    this.end = end;
    return this;
 ...
 * @constructor
 */
const InCondition = exports.InCondition = function InCondition(values, not) {
    this.isNot = not === true;
    this.values = values;
    return this;
};
 ...
 * @constructor
 */
const LikeCondition = exports.LikeCondition = function LikeCondition(value, not) {
    this.isNot = not === true;
    this.value = value;
    return this;
};
 ...
 * @constructor
 */
const ConditionList = exports.ConditionList = function ConditionList(conditions, operator) {
 ...
 * @constructor
 */
const SubSelect = exports.SubSelect = function SubSelect(select, range) {
    this.select = select;
 ...
 * @constructor
 */
const Expression = exports.Expression = function Expression(andConditions, orConditions) {
 ...
 * @constructor
 */
const HavingClause = exports.HavingClause = function HavingClause(expression) {
 ...
 * @constructor
 */
const OrderBy = exports.OrderBy = function OrderBy(expression, isReverse, nulls) {
    this.value = expression;
 ...
 * @constructor
 */
const OrderByClause = exports.OrderByClause = function OrderByClause(list) {
    this.list = list;
    return this;
};
/** @ignore */
 ...
 * @constructor
 */
const GroupByClause = exports.GroupByClause = function GroupByClause(list) {
    this.list = list;
    return this;
};
/** @ignore */
 ...
 * @constructor
 */
const WhereClause = exports.WhereClause = function WhereClause(expression) {
    this.value = expression;
    return this;
};
/** @ignore */
 ...
 * @constructor
 */
const FromClause = exports.FromClause = function FromClause(list) {
    this.list = list;
    return this;
};
/** @ignore */
 ...
 * @constructor
 */
const JoinClause = exports.JoinClause = function JoinClause(list) {
    this.list = list;
    return this;
};
/** @ignore */
 ...
 * @constructor
 */
const InnerJoin = exports.InnerJoin = function InnerJoin(entity, predicate) {
    this.entity = entity;
 ...
 * @constructor
 */
const OuterJoin = exports.OuterJoin = function OuterJoin(entity, predicate, side) {
    this.entity = entity;
    this.predicate = predicate;
    this.side = side;
    return this;
 ...
 * @constructor
 */
const RangeClause = exports.RangeClause = function RangeClause(offset, limit) {
 ...
 * @constructor
 */
const SelectClause = exports.SelectClause = function SelectClause(list, modifier) {
    this.list = list;
 ...
 * @constructor
 */
const SelectExpression = exports.SelectExpression = function SelectExpression(expression, alias) {
 ...
 * @constructor
 */
const SelectEntity = exports.SelectEntity = function SelectEntity(name) {
    this.name = name;
    return this;
};
/** @ignore */
 ...
 * @constructor
 */
const Aggregation = exports.Aggregation = function Aggregation(type, ident, distinct) {
    this.type = type;
    this.value = ident;
 ...
 * @constructor
 */
const Select = exports.Select = function Select(select, from, join, where, groupBy, having, orderBy, range) {
    this.select = select;
    this.from = from;
    this.join = join;
    this.where = where;
